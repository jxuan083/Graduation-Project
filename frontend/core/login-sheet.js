...
import { doEmailSignIn, doEmailSignUp, doGoogleLogin, doLocalDevLogin, doPasswordReset } from './firebase.js?v=63';
import { continueAsLocalGuest } from './guest.js?v=63';
import { impact } from './haptics.js?v=63';
