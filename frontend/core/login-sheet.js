...
import { doEmailSignIn, doEmailSignUp, doGoogleLogin, doLocalDevLogin, doPasswordReset } from './firebase.js?v=64';
import { continueAsLocalGuest } from './guest.js?v=64';
import { impact } from './haptics.js?v=64';
