...
import { doEmailSignIn, doEmailSignUp, doGoogleLogin, doLocalDevLogin, doPasswordReset } from './firebase.js?v=60';
import { continueAsLocalGuest } from './guest.js?v=60';
import { impact } from './haptics.js?v=60';
