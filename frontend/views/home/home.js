...
import { fetchMyGroups } from '../../features/groups/controller.js?v=59';
import { FIREBASE_EMULATORS } from '../../core/config.js';
import { openLoginMethodSheet } from '../../core/login-sheet.js?v=59';
...
function loadHomeOnboardingStyles() {
    ...
    link.rel = 'stylesheet';
    link.href = './views/home/home-onboarding.css?v=59';
