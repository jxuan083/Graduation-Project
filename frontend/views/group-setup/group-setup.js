...
import { PET_BODY_OPTIONS } from '../../core/config.js?v=51';
...
async function refreshGroupDetail() {
    ...
    try {
        const { fetchGroupDetail } = await import('../../features/groups/controller.js?v=51');
...
async function handleRefreshInvite() {
    ...
    try {
        const { refreshGroupInviteCode } = await import('../../features/groups/controller.js?v=51');
...
function renderMembers(g) {
    ...
    ul.querySelectorAll('.btn-rm-member').forEach(btn => {
        btn.onclick = async () => {
            ...
            try {
                const { removeGroupMember } = await import('../../features/groups/controller.js?v=51');
...
async function handleSaveName() {
    ...
    try {
        const { createGroup, updateGroupName } = await import('../../features/groups/controller.js?v=51');
        if (!currentGroupId) {
...
async function handleAddMember() {
    ...
    try {
        const { addGroupMember } = await import('../../features/groups/controller.js?v=51');
...
async function handleSavePetBody() {
    ...
    if (!currentGroupId) return;
    try {
        const { updatePet } = await import('../../features/groups/controller.js?v=51');
