...
async function handleJoinByInvite() {
    ...
    try {
        const { getGroupInviteInfo, joinGroupByInviteCode, fetchMyGroups } = await import('../../features/groups/controller.js?v=63');
...
async function handleCreateGroup() {
    ...
    try {
        const { createGroup, addGroupMember, fetchMyGroups } = await import('../../features/groups/controller.js?v=63');
