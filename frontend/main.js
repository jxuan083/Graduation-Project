...
import { initI18n, t } from './core/i18n.js?v=28';
...
const VIEW_MODULES = {
    'home':              () => import('./views/home/home.js?v=28'),
    'scanner':           () => import('./views/scanner/scanner.js?v=28'),
    'meetings':          () => import('./views/meetings/meetings.js?v=28'),
    ...
    'qa-source':         () => import('./views/qa-source/qa-source.js?v=28'),
    'qa-picker':         () => import('./views/qa-picker/qa-picker.js?v=28'),
    'profile':           () => import('./views/profile/profile.js?v=28'),
    'join':              () => import('./views/join/join.js?v=28'),
    'waiting-room':      () => import('./views/waiting-room/waiting-room.js?v=28'),
    'host-room':         () => import('./views/host-room/host-room.js?v=28'),
    'sync-ritual':       () => import('./views/sync-ritual/sync-ritual.js?v=28'),
    'focus':             () => import('./views/focus/focus.js?v=28'),
    'qa-game':           () => import('./views/qa-game/qa-game.js?v=28'),
