...
import { initI18n, t } from './core/i18n.js?v=29';
...
const VIEW_MODULES = {
    'home':              () => import('./views/home/home.js?v=29'),
    'scanner':           () => import('./views/scanner/scanner.js?v=29'),
    'meetings':          () => import('./views/meetings/meetings.js?v=29'),
    'meeting-detail':    () => import('./views/meeting-detail/meeting-detail.js?v=29'),
    'friends':           () => import('./views/friends/friends.js?v=29'),
    'leaderboard':       () => import('./views/leaderboard/leaderboard.js?v=29'),
    'photo-lightbox':    () => import('./views/photo-lightbox/photo-lightbox.js?v=29'),
    'question-bank':     () => import('./views/question-bank/question-bank.js?v=29'),
    'question-edit':     () => import('./views/question-edit/question-edit.js?v=29'),
    'qa-source':         () => import('./views/qa-source/qa-source.js?v=29'),
    'qa-picker':         () => import('./views/qa-picker/qa-picker.js?v=29'),
    'profile':           () => import('./views/profile/profile.js?v=29'),
    'join':              () => import('./views/join/join.js?v=29'),
    'waiting-room':      () => import('./views/waiting-room/waiting-room.js?v=29'),
    'host-room':         () => import('./views/host-room/host-room.js?v=29'),
    'sync-ritual':       () => import('./views/sync-ritual/sync-ritual.js?v=29'),
    'focus':             () => import('./views/focus/focus.js?v=29'),
    'qa-game':           () => import('./views/qa-game/qa-game.js?v=29'),
    'taboo-prepare':     () => import('./views/taboo-prepare/taboo-prepare.js?v=29'),
    'taboo-countdown':   () => import('./views/taboo-countdown/taboo-countdown.js?v=29'),
    'taboo-card':        () => import('./views/taboo-card/taboo-card.js?v=29'),
    'buffer':            () => import('./views/buffer/buffer.js?v=29'),
    'summary':           () => import('./views/summary/summary.js?v=29'),
    'member-preview':    () => import('./views/member-preview/member-preview.js?v=29'),
    'invite-modal':      () => import('./views/invite-modal/invite-modal.js?v=29'),
    'meeting-setup':     () => import('./views/meeting-setup/meeting-setup.js?v=29'),
    'groups':            () => import('./views/groups/groups.js?v=29'),
    'group':             () => import('./views/group/group.js?v=29'),
    'group-setup':       () => import('./views/group-setup/group-setup.js?v=29'),
    'group-invite':      () => import('./views/group-invite/group-invite.js?v=29'),
    'pet-vote':          () => import('./views/pet-vote/pet-vote.js?v=29'),
    'group-chat':        () => import('./views/group-chat/group-chat.js?v=29'),
    'friend-profile':    () => import('./views/friend-profile/friend-profile.js?v=29'),
    'pet-swap':          () => import('./views/pet-swap/pet-swap.js?v=29'),
    'pet-tamagotchi':    () => import('./views/pet-tamagotchi/pet-tamagotchi.js?v=29'),
};
