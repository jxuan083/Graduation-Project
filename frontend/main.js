...
import { showJoinView } from './views/join/join.js?v=50';
import { events } from './core/events.js';
import { initI18n, t } from './core/i18n.js?v=50';
...
const VIEW_MODULES = {
    'home':              () => import('./views/home/home.js?v=50'),
    'more':              () => import('./views/more/more.js?v=50'),
    'scanner':           () => import('./views/scanner/scanner.js?v=50'),
    'meetings':          () => import('./views/meetings/meetings.js?v=50'),
    'meeting-detail':    () => import('./views/meeting-detail/meeting-detail.js?v=50'),
    'friends':           () => import('./views/friends/friends.js?v=50'),
    'leaderboard':       () => import('./views/leaderboard/leaderboard.js?v=50'),
    'photo-lightbox':    () => import('./views/photo-lightbox/photo-lightbox.js?v=50'),
    'question-bank':     () => import('./views/question-bank/question-bank.js?v=50'),
    'question-edit':     () => import('./views/question-edit/question-edit.js?v=50'),
    'qa-source':         () => import('./views/qa-source/qa-source.js?v=50'),
    'qa-picker':         () => import('./views/qa-picker/qa-picker.js?v=50'),
    'profile':           () => import('./views/profile/profile.js?v=50'),
    'join-method':       () => import('./views/join-method/join-method.js?v=50'),
    'join':              () => import('./views/join/join.js?v=50'),
    'waiting-room':      () => import('./views/waiting-room/waiting-room.js?v=50'),
    'host-room':         () => import('./views/host-room/host-room.js?v=50'),
    'sync-ritual':       () => import('./views/sync-ritual/sync-ritual.js?v=50'),
    'focus':             () => import('./views/focus/focus.js?v=50'),
    'qa-game':           () => import('./views/qa-game/qa-game.js?v=50'),
    'taboo-prepare':     () => import('./views/taboo-prepare/taboo-prepare.js?v=50'),
    'taboo-countdown':   () => import('./views/taboo-countdown/taboo-countdown.js?v=50'),
    'taboo-card':        () => import('./views/taboo-card/taboo-card.js?v=50'),
    'buffer':            () => import('./views/buffer/buffer.js?v=50'),
    'summary':           () => import('./views/summary/summary.js?v=50'),
    'meeting-news':      () => import('./views/meeting-news/meeting-news.js?v=50'),
    'member-preview':    () => import('./views/member-preview/member-preview.js?v=50'),
    'invite-modal':      () => import('./views/invite-modal/invite-modal.js?v=50'),
    'meeting-setup':     () => import('./views/meeting-setup/meeting-setup.js?v=50'),
    'groups':            () => import('./views/groups/groups.js?v=50'),
    'group':             () => import('./views/group/group.js?v=50'),
    'group-setup':       () => import('./views/group-setup/group-setup.js?v=50'),
    'group-invite':      () => import('./views/group-invite/group-invite.js?v=50'),
    'group-chat':        () => import('./views/group-chat/group-chat.js?v=50'),
    'friend-profile':    () => import('./views/friend-profile/friend-profile.js?v=50'),
    'pet-swap':          () => import('./views/pet-swap/pet-swap.js?v=50'),
    'pet-tamagotchi':    () => import('./views/pet-tamagotchi/pet-tamagotchi.js?v=50'),
};
...
function handleGroupInviteOnBoot(code) {
    async function tryJoin() {
        ...
        try {
            const { getGroupInviteInfo, joinGroupByInviteCode } = await import('./features/groups/controller.js?v=50');
