...
const VIEW_MODULES = {
    'home':              () => import('./views/home/home.js?v=22'),
    'scanner':           () => import('./views/scanner/scanner.js?v=22'),
    'meetings':          () => import('./views/meetings/meetings.js?v=22'),
    'meeting-detail':    () => import('./views/meeting-detail/meeting-detail.js?v=22'),
    'friends':           () => import('./views/friends/friends.js?v=22'),
    'leaderboard':       () => import('./views/leaderboard/leaderboard.js?v=22'),
    'about':             () => import('./views/about/about.js?v=22'),
    'photo-lightbox':    () => import('./views/photo-lightbox/photo-lightbox.js?v=22'),
    'question-bank':     () => import('./views/question-bank/question-bank.js?v=22'),
    'question-edit':     () => import('./views/question-edit/question-edit.js?v=22'),
    'qa-source':         () => import('./views/qa-source/qa-source.js?v=22'),
    'qa-picker':         () => import('./views/qa-picker/qa-picker.js?v=22'),
    'profile':           () => import('./views/profile/profile.js?v=22'),
    'join':              () => import('./views/join/join.js?v=22'),
    'waiting-room':      () => import('./views/waiting-room/waiting-room.js?v=22'),
    'host-room':         () => import('./views/host-room/host-room.js?v=22'),
    'sync-ritual':       () => import('./views/sync-ritual/sync-ritual.js?v=22'),
    'focus':             () => import('./views/focus/focus.js?v=22'),
    'qa-game':           () => import('./views/qa-game/qa-game.js?v=22'),
    'taboo-prepare':     () => import('./views/taboo-prepare/taboo-prepare.js?v=22'),
    'taboo-countdown':   () => import('./views/taboo-countdown/taboo-countdown.js?v=22'),
    'taboo-card':        () => import('./views/taboo-card/taboo-card.js?v=22'),
    '67-game':           () => import('./views/67-game/67-game.js?v=22'),
    'buffer':            () => import('./views/buffer/buffer.js?v=22'),
    'summary':           () => import('./views/summary/summary.js?v=22'),
    'member-preview':    () => import('./views/member-preview/member-preview.js?v=22'),
    'invite-modal':      () => import('./views/invite-modal/invite-modal.js?v=22'),
    'meeting-setup':     () => import('./views/meeting-setup/meeting-setup.js?v=22'),
    'groups':            () => import('./views/groups/groups.js?v=22'),
    'group-setup':       () => import('./views/group-setup/group-setup.js?v=22'),
};
